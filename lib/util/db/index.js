 ...
 */
exports.getIgnoredSellers = async (guildId) => {
  try {
 ...
 */
exports.hasIgnoredSeller = async (guildId, sellerTitle) => {
  try {
    const guild = await Guild.findByPk(guildId, {
      include: [{
        model: Seller,
 ...
 */
exports.insertIgnoredSeller = async (guildId, sellerTitle) => {
  try {
 ...
 */
exports.removeIgnoredSeller = async (guildId, sellerTitle) => {
  try {
    const server = await Guild.findByPk(guildId);
    const seller = await Seller.findOne({ where: getSellerTitleSearch(sellerTitle) });
 ...
 */
exports.clearIgnoredSellers = async (guildId) => {
  try {
 ...
 */
exports.openDatabase = async (bot) => {
  try {
